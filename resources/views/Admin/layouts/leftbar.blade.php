...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="index.html"><img src="/uploads/setting/{{$setting->logo}}" class="main-logo" alt="logo"></a>
        <a class="desktop-logo logo-dark active" href="index.html"><img src="/uploads/setting/{{$setting->logo}}" class="main-logo dark-theme" alt="logo"></a>
        <a class="logo-icon mobile-logo icon-light active" href="index.html"><img src="/admin/img/brand/favicon.png" class="logo-icon" alt="logo"></a>
        <a class="logo-icon mobile-logo icon-dark active" href="index.html"><img src="/admin/img/brand/favicon-white.png" class="logo-icon dark-theme" alt="logo"></a>
    </div>
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item"   data-toggle="slide" href="index-2.html#"> <span class="side-menu__label">Üyeler</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">

                    <li><a class="slide-item" href="{{route('user.create')}}">Yeni üye ekle</a></li>
                    <li><a class="slide-item" href="{{route('user.index')}}">Site Üyeleri</a></li>
                    <li><a class="slide-item" href="{{route('user.admins')}}">Yöneticiler</a></li>
