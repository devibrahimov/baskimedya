        ...
        <div class="col-xl-12 col-lg-12 col-md-12">
            ...
            <div class="row row-sm">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3  col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="pro-img-box"  style="height:309px;  background: url('/storage/uploads/thumbnail/products/medium/{{$product->image}}') no-repeat;
                                background-size: cover;background-position: center center !important;">

                                 <div style="height:300px;background: url('/uploads/products/{{$product->image}}') no-repeat;
